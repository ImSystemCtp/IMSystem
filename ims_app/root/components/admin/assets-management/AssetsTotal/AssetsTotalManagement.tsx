...
export default function AssetsTotalManagement() {
  ...
  const handleExcel = async () => {
    ...
    } else { toast.error('No hay activos para generar el reporte'); }
  };
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-row  my-2 md:p-4 md:m-4 justify-center items-center ">
        <div className=" flex justify-left  items-left flex-col md:flex-row  gap-4 mr-4">
          <button onClick={handleGetTotalAssets}
            className="bg-slate-500 hover:bg-slate-400 text-white font-semibold md:font-bold py-2 px-4 mx-4 rounded" > Obtener Bienes
          </button>
          <button onClick={handleGetTotalLows}
            className="bg-slate-500 hover:bg-slate-400 text-white font-semibold md:font-bold py-2 px-4 mx-4 rounded" > Obtener Bajas
          </button>
          <button onClick={handleGetTotal}
            className="bg-slate-500 hover:bg-slate-400 text-white font-semibold md:font-bold py-2 px-4 mx-4 rounded" > Obtener Registro Total
          </button>
        </div>
