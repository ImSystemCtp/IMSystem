...
export default function SearchAssetsInfo() {
    ...
    const handleSubmit = () => { if (noAssets === "") return; }
        ...
        <div className="border-2  rounded-lg border-slate-300 shadow-sm shadow-slate-300 flex flex-col md:flex-row md:m-2 md:p-2">
                    ...
                    <form>
                        ...
                        <div className="relative">
                            ...
                            <input value={noAssets}
                                type="search" onChange={(e) => setNoAssets(e.target.value)}
                            ...
                            <button onClick={handleSubmit} type="button" className="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-400  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buscar </button>
                        </div>
                    </form>
                </div>
            </div>
            <div className="justify-center items-center m-2 flex flex-col md:flex-row w-full md:flex-grow  md:mx-4 md:mr-2">
                <div className="m-4 md:w-60 md:px-4 ">
                    <select onChange={handleSelect} id="locations"
