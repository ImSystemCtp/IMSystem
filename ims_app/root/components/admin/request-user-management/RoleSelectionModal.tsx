    ...
    return (
        ...
        >
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="btn-usuario bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded m-2"
                onClick={() => {
            ...
            <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="btn-administrador bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded m-2"
                onClick={() => {
