...
export default function RegisterGoods() {
    return (
        <div className="w-3/4 mx-auto p-4">
            ...
            >
                <div className="border-2 rounded-lg border-slate-300 shadow-lg shadow-slate-300 bg-gradient-to-br from-slate-300 to-white p-4">
                    <Form>
                        ...
                        <div className="space-y-4">
                            ...
                            <CustomInput label="Modelo:" name="contact" inputType="text" />
                            <CustomInput
