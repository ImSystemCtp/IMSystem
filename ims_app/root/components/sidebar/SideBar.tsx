            ...
            >
                ...
                <div className="py-4 overflow-y-auto">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <button onClick={handleDropdownToggle} type="button" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-neutral-300 dark:hover:bg-gray-700 group" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                            ...
                            <ul id="dropdown-example" className={`py-2 space-y-2 ${isDropdownOpen ? '' : 'hidden'}`}>
                                <li>
                                    <Link
                                        ...
                                        className={`flex items-center ml-3 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-neutral-300 dark:hover:bg-gray-700 group ${
                                        ...
                                        <span className="text-black  flex-1 ml-3 whitespace-nowrap">Bienes Por Ubicacion</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                    ...
                                    >
                                        ...
                                        <span className="text-black  flex-1 ml-3 whitespace-nowrap">Bienes Totales</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                    ...
                                    >
                                        ...
                                        <span className="text-black ml-3">Registrar Activos</span>
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            >
                                ...
                                <span className="text-black  flex-1 ml-3 whitespace-nowrap">
                                    Ubicaciones
                                </span>
                            </Link>
                        </li>
                        <li>
                            ...
                            >
                                ...
                                <span className="text-black  flex-1 ml-3 whitespace-nowrap">Leyes</span>
                            </Link>
                        </li>

                        <li>
                            <button onClick={handleDropdownUserToggle} type="button" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-neutral-300 dark:hover:bg-gray-700 group" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                            ...
                            <ul id="dropdown-example" className={`py-2 space-y-2 ${isDropdownUserOpen ? '' : 'hidden'}`}>
                                <li>
                                    <Link
                                        ...
                                        className="flex items-center p-2 ml-3 text-gray-900 rounded-lg dark:text-white hover:bg-neutral-300 dark:hover:bg-gray-700 group"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                                        </svg>
                                        <span className="text-black  flex-1 ml-3 whitespace-nowrap">Editar Usuarios</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                    ...
                                    >
                                        ...
                                        <span className="text-black  flex-1 ml-3 whitespace-nowrap">Solicitudes de Usuarios</span>
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            >
                                ...
                                <span className="text-black  flex-1 ml-3 whitespace-nowrap">Bajas</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="text-black  flex-1 ml-3 whitespace-nowrap">Traslados</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="text-black  flex-1 ml-3 whitespace-nowrap">Gestion de Solicitudes</span>
                            </Link>
                        </li>
                    </ul>
                </div>
