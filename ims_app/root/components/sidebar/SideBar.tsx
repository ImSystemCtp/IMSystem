                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link
                                ...
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-sky-400 dark:hover:bg-gray-700 group"
                            >
                                ...
                                <span className="text-white-400 ml-3">Registrar Bienes</span>
                            </Link>
                        </li>
                        <li>
                            <Link
