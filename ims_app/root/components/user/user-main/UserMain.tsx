    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center w-full h-screen">
            {optionsList.map((menuItem, index) => (
                <motion.div whileHover={{ scale: 1.05, transition: { duration: 0.2 } }} whileTap={{ scale: 0.95 }} className="flex flex-col md:flex-row m-4 items-center justify-center" key={index}>
