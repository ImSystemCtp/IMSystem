...
interface AssetItemProps { asset: ims_assets; isAdminTable: boolean}
        ...
        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td className="px-6 py-4 ">
                <div className="flex items-center justify-center mb-4" onClick={() => {
                    ...
                    if (checkbox) {
                        if (!checkbox.checked) { deleteAssetsCheck(asset); }
                        else { addAssetsCheck(asset); }
                    }
                }}>
                    <input id={`checkbox-${asset.assets_no}`} type="checkbox" checked={assetsCheck.includes(asset)}
            ...
            </td>
            {
                !isAdminTable?(
                    ...
                    {isChecked(asset) && (
                        ...
                        onClick={ () => setAsset(asset) }> Agregar Detalle </button>
                    )}
                </td>):("")
            }
        </tr>
